...
export function Footer() {
  return (
    <footer className="relative overflow-hidden bg-[oklch(36.9%_0.07_154.2)] text-[oklch(95.8%_0.012_91.5)]">
      <span
        aria-hidden="true"
        className="font-heading pointer-events-none absolute -bottom-10 left-1/2 w-full -translate-x-1/2 text-center text-[18vw] leading-none font-semibold whitespace-nowrap text-[oklch(95.8%_0.012_91.5)]/[0.05] select-none md:text-[13rem]"
      >
        ARG TECH
      </span>
      ...
      <div className="relative mx-auto max-w-6xl px-6 pt-20 pb-10">
        ...
        <div className="mt-16 flex flex-col-reverse items-center justify-between gap-6 sm:flex-row">
          ...
          <div className="flex items-center gap-6">
            <Link
              ...
              className="flex items-center gap-1.5 text-sm text-[oklch(95.8%_0.012_91.5)]/50 transition-colors hover:text-[oklch(95.8%_0.012_91.5)]"
            >
